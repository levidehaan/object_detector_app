...
class HLSVideoStream:
    def __init__(self, src):
        ...
        while "streams" not in metadata.keys():
            ...
            out, err = info.communicate(b"ffprobe -v quiet -print_format json -show_format -show_streams %a" % (src))
        ...
        self.pipe = sp.Popen([FFMPEG_BIN, "-i", src,
                              ...
                              "-vf", "unsharp=luma_msize_x=3:luma_msize_y=3:luma_amount=3",
                              "-vf", "eq=gamma=5.123",
                              "-vf", "unsharp=3:3:5",
                              "-vf", "hue=b=1.7",
                              "-vcodec", "rawvideo", "-"],
...
def standard_colors():
    colors = ['AliceBlue', 'Chartreuse', 'Aqua', 'Aquamarine', 'Azure', 'Beige', 'Bisque',
...
def draw_boxes_and_labels(boxes,
                          classes,
                          scores,
                          category_index,
                          instance_masks=None,
